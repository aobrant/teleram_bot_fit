...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/alexanderobrant/Python/telegram_bot_fit/env'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/alexanderobrant/Python/telegram_bot_fit/env/bin/deactivate.nu'
